...
(1, 1, 'Shanjid', 'Male', '0171111111', 'shanjid@gmail.com', 2, 0, 2, 'Something', 'Confirm');
...
INSERT INTO `reviews` (`id`, `pid`, `rating`, `review`) VALUES
(2, 1, 5, 'dqwfwegdr'),
(3, 1, 4, 'hello');
...
--
ALTER TABLE `enquiry`
  MODIFY `Enquiryid` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
