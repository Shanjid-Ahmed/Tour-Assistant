...
<tr><td align="left" colspan="3" height="50px"><a href="enquiry.php?pid=<?php echo $data[0];   ?>"><input type="button" value="Book This" name="sbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
...
<div style="margin: 20px 145px;">
	<h4>Add Review</h4>
	<div style="margin: 20px 0px">
		<form method="post" action="addreview.php?pid=<?=$_GET["pid"]?>">
			Rating out of 5:<br/>
			<select name="rating">
			<?php for($i=5;$i>0;$i--)
			{
	...
	<h4>Reviews</h4>
<?php $results = $cn->query("SELECT * FROM reviews WHERE pid=".$_GET["pid"]); ?>
	<table style="margin: 20px 0px">
	<?php while($res=$results->fetch_assoc()): ?>
		<tr>
			<td style="border:1px solid black; padding: 20px;margin: 1px"><?=$res["rating"]?> out of 5</td><td style="border:1px solid black; padding: 20px;margin: 1px"><?=$res["review"]?></td>
		</tr>
	<?php endwhile; ?>
	</table>
</div>
